(function(){var t,i,e;e='<div class="zNotifications-notification"><span class="notification-icon">!</span> <span class="body">Test notification</span><a class="close" href="#Close">&times;</a>\n  <div style="clear: both"></div>\n</div>',i=function(){function i(t){if(this.elem=t,"function"!=typeof jQuery)throw new Error("jQuery Required!");this.elem.addClass("zNotifications-notifications")}return i.prototype.ids={},i.prototype.register=function(t,i){if(this.ids[t])throw new Error("UniqueError: "+t+" is already registered");return this.ids[t]=i},i.prototype.get=function(t,i){if(!this.ids[t]&&i)throw new Error("UndefinedError: "+t+" is not registered");return this.ids[t]},i.prototype.unregister=function(t,i){if(!this.ids[t])throw new Error("UndefinedError: "+t+" is not registered");return delete this.ids[t]},i.prototype.test=function(){return setTimeout(function(t){return function(){return t.add("connection","error","Connection lost to <b>UiServer</b> on <b>localhost</b>!"),t.add("message-Anyone","info","New  from <b>Anyone</b>.")}}(this),1e3),setTimeout(function(t){return function(){return t.add("connection","done","<b>UiServer</b> connection recovered.",5e3)}}(this),3e3)},i.prototype.add=function(i,e,s,n,o,r){return null==n&&(n=0),null==o&&(o={}),new t(this,{id:i,type:e,body:s,timeout:n,options:o,cb:r})},i.prototype.close=function(t){return this.get(t,!0).close("script",!0)},i.prototype.closeAll=function(){var t;t=this,Object.keys(this.ids).map(function(i){return t.close(i)})},i.prototype.randomId=function(){return"msg"+Math.random().toString().replace(/0/g,"").replace(/\./g,"")},i.prototype.displayMessage=function(t,i,e,s){return null==e&&(e=0),add(randomId(),t,i,e,{},s)},i.prototype.displayConfirm=function(t,i,e,s){return null==e&&(e=!1),add(randomId(),"confirm",t,0,{confirm_label:i,cancel_label:e},s)},i.prototype.displayPrompt=function(t,i,e,s){return null==e&&(e=!1),add(randomId(),"prompt",t,0,{confirm_label:i,cancel_label:e},s)},i}(),t=function(){function t(t,i){var s,n;this.main=t,this.main_elem=this.main.elem,this.options=i.options,this.cb=i.cb,this.id=i.id.replace(/[^A-Za-z0-9]/g,""),this.main.get(this.id)&&this.main.get(this.id).close(),this.type=i.type,this["is"+this.type.substr(0,1).toUpperCase()+this.type.substr(1)]=!0,this.isProgress?this.RealTimeout=i.timeout:this.isInput||this.isConfirm||(this.Timeout=i.timeout),this.main.register(this.id,this),this.elem=$(e),this.isProgress&&this.elem.addClass("notification-done"),this.updateText(this.type),s=i.body,this.body=s,this.closed=!1,this.rebuildMsg(""),this.elem.appendTo(this.main_elem),this.Timeout&&($(".close",this.elem).remove(),setTimeout(function(t){return function(){return t.close()}}(this),this.Timeout)),this.isProgress&&this.setProgress(this.options.progress||0),this.isPrompt&&this.buildPrompt($(".body",this.elem),this.options.confirm_label||"Ok",this.options.cancel_label||!1),this.isConfirm&&this.buildConfirm($(".body",this.elem),this.options.confirm_label||"Ok",this.options.cancel_label||!1),n=this.elem.outerWidth(),this.elem.outerHeight()>55&&this.elem.addClass("long"),this.elem.css({width:"50px",transform:"scale(0.01)"}),this.elem.animate({scale:1},800,"easeOutElastic"),this.elem.animate({width:n},700,"easeInOutCubic"),$(".body",this.elem).cssLater("box-shadow","0px 0px 5px rgba(0,0,0,0.1)",1e3),setTimeout(this.resizeBox.bind(this),1500),setTimeout(function(){return console.log(this.id)}.bind(this),1500),$(".close",this.elem).on("click",function(t){return function(){return t.close("user",!0),!1}}(this)),$(".zNotifications-button",this.elem).on("click",function(t){return function(){return t.close(),!1}}(this)),$(".select",this.elem).on("click",function(t){return function(){return t.close()}}(this))}return t.prototype.resizeBox=function(){return this.elem.css("width","inherit")},t.prototype.callBack=function(t,i){if(this.called)throw new Error("CalbackError: Callback was called twice");return this.called=!0,"function"!=typeof this.cb?void console.warn("Silently failing callback @ %s: %s & '%s'",this.id,t,i):(console.info("Event @ %s %s %s",this.id,t,i),this.cb(t,i))},t.prototype.rebuildMsg=function(t){return this.append=$(t),"string"==typeof this.body?$(".body",this.elem).html("<span class='message'>"+this.escape(this.body)+"</span>").append(this.append):$(".body",this.elem).html("").append(this.body,this.append)},t.prototype.escape=function(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/&lt;([\/]{0,1}(br|b|u|i))&gt;/g,"<$1>")},t.prototype.setBody=function(t){return this.body=t,"string"==typeof this.body?(this.body=$("<span>"+this.escape(this.body)+"</span>"),$(".body .message",this.elem).empty().append(this.body)):$(".body .message",this.elem).empty().append(this.body),this.resizeBox(),this},t.prototype.buildConfirm=function(t,i,e){var s,n;return null==e&&(e=!1),s=$("<a href='#"+i+"' class='zNotifications-button zNotifications-button-confirm'>"+i+"</a>"),s.on("click",function(t){return function(){return t.callBack("action",!0),!1}}(this)),t.append(s),e&&(n=$("<a href='#"+e+"' class='zNotifications-button zNotifications-button-cancel'>"+e+"</a>"),n.on("click",function(t){return function(){return t.callBack("action",!1),!1}}(this)),t.append(n)),s.focus(),$(".notification").scrollLeft(0)},t.prototype.buildPrompt=function(t,i,e){var s,n,o;return null==e&&(e=!1),o=$("<input type='text' class='input'/>"),o.on("keyup",function(t){return function(t){if(13===t.keyCode)return s.trigger("click")}}(this)),t.append(o),s=$("<a href='#"+i+"' class='zNotifications-button zNotifications-button-confirm'>"+i+"</a>"),s.on("click",function(t){return function(){return t.callBack("action",o.val()),!1}}(this)),t.append(s),e&&(n=$("<a href='#"+e+"' class='zNotifications-button zNotifications-button-cancel'>"+e+"</a>"),n.on("click",function(t){return function(){return t.callBack("action",!1),!1}}(this)),t.append(n)),o.focus(),$(".notification").scrollLeft(0)},t.prototype.setProgress=function(t){var i,e,s,n;if("number"!=typeof t)throw new Error("TypeError: Progress must be int");return this.resizeBox(),s=Math.min(100,t)/100,e=75-75*s,i='<div class="circle"><svg class="circle-svg" width="30" height="30" viewport="0 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg">\n  \t\t\t\t<circle r="12" cx="15" cy="15" fill="transparent" class="circle-bg"></circle>\n  \t\t\t\t<circle r="12" cx="15" cy="15" fill="transparent" class="circle-fg" style="stroke-dashoffset: '+e+'"></circle>\n</svg></div>',n=$(".body .message",this.elem).outerWidth(),$(".circle",this.elem).length||this.rebuildMsg(i),""===$(".body .message",this.elem).css("width")&&$(".body .message",this.elem).css("width",n),$(".body .circle-fg",this.elem).css("stroke-dashoffset",e),s>0&&$(".body .circle-bg",this.elem).css({"animation-play-state":"paused","stroke-dasharray":"180px"}),!$(".notification-icon",this.elem).data("done")&&(t>=100?($(".circle-fg",this.elem).css("transition","all 0.3s ease-in-out"),setTimeout(function(){return $(".notification-icon",this.elem).css({transform:"scale(1)",opacity:1}),$(".notification-icon .icon-success",this.elem).css({transform:"rotate(45deg) scale(1)"})},300),this.RealTimeout&&($(".close",this.elem).remove(),setTimeout(function(t){return function(){return t.close("auto",!0)}}(this),this.RealTimeout)),$(".notification-icon",this.elem).data("done",!0)):t<0&&($(".body .circle-fg",this.elem).css("stroke","#ec6f47").css("transition","transition: all 0.3s ease-in-out"),setTimeout(function(t){return function(){return $(".notification-icon",t.elem).css({transform:"scale(1)",opacity:1}),t.elem.removeClass("notification-done").addClass("notification-error"),$(".notification-icon .icon-success",t.elem).removeClass("icon-success").html("!")}}(this),300),$(".notification-icon",this.elem).data("done",!0)),this)},t.prototype.setDesign=function(t,i){return $(".notification-icon",this.elem).html(t),this.elem.addClass("notification-"+i)},t.prototype.updateText=function(t){switch(t){case"error":return this.setDesign("!","error");case"done":return this.setDesign("<div class='icon-success'></div>","done");case"progress":return this.setDesign("<div class='icon-success'></div>","progress");case"ask":case"list":case"prompt":case"confirm":return this.setDesign("?","ask");case"info":return this.setDesign("i","info");default:throw new Error("UnknownNotificationType: Type "+t+" is not known")}},t.prototype.close=function(t,i){var e;if(null==t&&(t="auto"),null==i&&(i=!1),!this.closed)return this.closed=!0,!i&&this.called||this.callBack(t),$(".close",this.elem).remove(),this.main.unregister(this.id),this.elem.stop().animate({width:0,opacity:0},700,"easeInOutCubic"),e=this.elem,this.elem.slideUp(300,function(){return e.remove()}),this.main},t}(),window.Notifications=i}).call(this);
